...
Param( $FileToCompile = "C:\Users\samueAppData\Roaming\MetaQuotes\Terminal\FB9A56D617EDDDFE29EE54EBEFFE96C1\MQL5\Experts\Teste_DC_Stock\OHLC\DonchianChannel_05_OHLC.mq5.mq5")
...
if ($FileToCompile.Contains(" ")) {
    "";"";
    Write-Host "ERRO! Impossível compilar! Seu nome de arquivo ou caminho contém ESPAÇOS!" -ForegroundColor Red;
    "";s
...
& "C:\Program Files\MetaTrader 5 Terminal\terminal64.exe" /compile:"$FileToCompile" /log:"$LogFile" /inc:"C:\Users\samueAppData\Roaming\MetaQuotes\Terminal\FB9A56D617EDDDFE29EE54EBEFFE96C1\MQL5" | Out-Null
